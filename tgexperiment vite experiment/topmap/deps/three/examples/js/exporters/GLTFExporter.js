  ...
  parse: function (input, onDone, options) {
    ...
    function processMaterial(material) {
      ...
      if (material.isGLTFSpecularGlossinessMaterial) {
        ...
        gltfMaterial.extensions.KHR_materials_pbrSpecularGlossiness.specularFactor =
          specularFactor;
      ...
      if (material.map) {
        ...
        if (material.isGLTFSpecularGlossinessMaterial) {
          gltfMaterial.extensions.KHR_materials_pbrSpecularGlossiness.diffuseTexture =
            baseColorMapDef;
        }
      ...
      if (material.isGLTFSpecularGlossinessMaterial && material.specularMap) {
        ...
        gltfMaterial.extensions.KHR_materials_pbrSpecularGlossiness.specularGlossinessTexture =
          specularMapDef;
      }
